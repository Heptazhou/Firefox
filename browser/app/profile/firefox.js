...
pref("app.update.multiSessionInstallLockout.enabled", true);
  ...
  pref("toolkit.backgroundtasks.defaultTimeoutSec", 600);
    ...
    // Test prefs to verify background tasks inherit and override browser prefs
    // correctly.
...
pref("browser.tabs.min_inactive_duration_before_unload", 1200000);
...
pref("sidebar.old-sidebar.has-used", true);
