...
pref("font.size.monospace.x-math", 13);
  ...
  pref("font.name-list.sans-serif.zh-TW", "Saranya UI TC H, Saranya UI TC, Source Han Sans TC, Noto Sans CJK TC, Arial, Microsoft JhengHei, PMingLiU, MingLiU, MingLiU-ExtB");
